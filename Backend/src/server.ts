    ...
    const initialBlogs = [
      {
        ...
        content: "Next.js provides SSR, SSG, file-based routing, and incredible performance out of the box. The developer experience is unmatched — from automatic code splitting to the built-in Image optimization. If you're still debating whether to use Next.js, the answer is almost always yes for production apps.",
        category: "Next.js",
      ...
      },
      {
        ...
        content: "Starting with Node.js felt overwhelming but the ecosystem is incredible. I began with Express.js to understand how servers work, then moved to MongoDB for data persistence. The MERN stack is powerful because JavaScript is used everywhere — from the UI to the database queries.",
        category: "Backend",
